        ...
        if (usernameOrEmail != null) {
            ...
            if (!captchaOk) {
                ...
                if (emailPassword(password, user.getUsername(), user.getEmail())) {
                    ...
                    UserCredential uc = new UserCredential(user.getUsername(), user.getUsername(), password, settingsService.getAirsonicPasswordEncoder(), "airsonic", "Autogenerated recovery credentials");
