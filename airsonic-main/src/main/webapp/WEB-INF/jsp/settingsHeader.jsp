...
<c:set var="categories" value="${param.restricted ? 'personal credentials password player share' : 'musicFolder general advanced personal credentials user player share dlna sonos transcoding internetRadio podcast database'}"/>
<h1>
