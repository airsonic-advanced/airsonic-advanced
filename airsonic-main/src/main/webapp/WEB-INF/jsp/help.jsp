...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString} [Commit: <a href="https://github.com/airsonic-advanced/airsonic-advanced/commit/${buildNumber}" target="_blank">${buildNumber}</a>]</td></tr>
