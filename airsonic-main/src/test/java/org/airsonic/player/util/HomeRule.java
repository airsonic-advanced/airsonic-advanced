...
/**
 * 
 * This must be a ClassRule for Spring tests, because it needs to be executed prior to the context initiation. 
 * Context picks up home from property set by this class. If home is set after context init, the context won't
 * see it, and point to the wrong home.
 *
 */
